...
parser.add_argument('--sms', '-S', type=int
                    help='Number of sms to target (default: 50000)', default=50000)
...
parser.add_argument('--proxy', '-p', action='store_true',
                    help='Use proxy for bombing (It is advisable to use this option if you are bombing more than 5000 sms)')
